...
先自己看一遍 `skill/ngan-dict-code-review`。 如果你無法訪問skill 就手動翻閱 `.agents/skills/ngan-dict-code-review/SKILL.typ`
...
示例: Ngan.Dict.Frontend/proj/Ngan.Dict.Ui/CodeTemplate/Sample/ViewSample.cs Ngan.Dict.Frontend/proj/Ngan.Dict.Ui/CodeTemplate/Sample/VmSample.cs
