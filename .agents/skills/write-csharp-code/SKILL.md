...
`<項目根目錄>/Doc/Spec/` 這個目錄下有項目說明和代碼規範。
...
在代碼加註釋文檔的規範 (大多數情況你不需要讀此文件 除非明確要求)
...
其次、根據你這次要做的任務、在上述文件中挑選你所需的來看。 比如我現在要你做前端的任務、你就得看Frontend.typ文件、別的就先不看。
